...
def parse_args():
    ...
    parser.add_argument("--request-rate", type=float, default=6.0, help="Poisson arrival rate in requests/s. Use 0 for a burst.")
    parser.add_argument("--min-input-len", type=int, default=1024)
    parser.add_argument("--max-input-len", type=int, default=3072)
