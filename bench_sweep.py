...
def parse_args():
    ...
    parser.add_argument("--gpu-memory-utilizations", default="0.84,0.86,0.88")
    parser.add_argument("--max-piecewise-cudagraph-tokens", default="256")
    parser.add_argument("--max-num-batched-tokens", default="1024,1280,1536,2048")
